...
class ServerEnv():
    ...
    def set_paths(self) -> None:
        ...
        self.required_paths = [os.path.dirname(self.server_data_file), os.path.dirname(self.log_file)]
    ...
    def test_write_permission(self, folder: str) -> bool:
        ...
        if not os.access(folder, os.W_OK):
            print(f"Warning: Folder {folder} exists but does not have write permission!")
            try:
