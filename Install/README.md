...
Install the Windows Package Manager (winget).

WinGet will not be available until you have logged into Windows as a user for the first time, triggering Microsoft Store to register the Windows Package Manager as part of an asynchronous process. See [MS Use the WinGet tool to install and manage applications](https://learn.microsoft.com/en-us/windows/package-manager/winget/) for more information.
...
Install Podman Desktop for Windows using winget:
...
Install Miniconda3 for Windows using winget:

```shell
winget install Miniconda.Miniconda3
```

## Data requirements

Please download the following data files:

- [Municipios 2022](https://geoftp.ibge.gov.br/organizacao_do_territorio/malhas_territoriais/malhas_municipais/municipio_2022/Brasil/BR/BR_Municipios_2022.zip)
- [Favelas e Comunidades Urbanas - 2022](https://geoservicos.ibge.gov.br/geoserver/CGMAT/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=CGMAT:qg_2022_670_fcu_agreg&outputFormat=SHAPE-ZIP)
- 
...
1. Instalar o utilitário de download wget
